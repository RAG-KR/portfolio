                ...
                <div className="space-y-3 relative z-10">
                  ...
                  <div className="flex gap-2 mt-4">
                    <button 
                      ...
                      className={`
                        flex-1 py-3 rounded-lg font-medium transition-all duration-500 relative overflow-hidden
                        ${hoveredProject === index 
                    ...
                    >
                      <span className="relative z-10">
                        {hoveredProject === index ? 'Launch Project →' : 'View Demo'}
                      </span>
                      {hoveredProject === index && (
                    ...
                    {project.videoUrl && (
                      <button
                        ...
                        className="px-4 py-3 rounded-lg wireframe hover:border-white/50 transition-all duration-300 group/video"
                        title="Watch Video"
                      >
                        <svg className="w-5 h-5 group-hover/video:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
